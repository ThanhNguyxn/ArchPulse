...
### Fixed
- **Draw.io Export**: Fixed duplicate node IDs causing draw.io to fail opening generated files
...
### Changed
- **Web Dashboard - Interactive Architecture Diagram**
  - Replaced Mermaid.js with Cytoscape.js for professional graph visualization
  - Added zoom, pan, and drag-drop node functionality
  - Physics-based `cose` layout for automatic node positioning
  - Hover highlighting shows connected dependencies
  - Control buttons: Fit View, Re-layout, Center, Export Mermaid
  - Improved node sizing and readability
  - Light/dark mode support for control buttons
