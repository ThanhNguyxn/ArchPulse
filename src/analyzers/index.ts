...
import { ArchitectureAnalysis, ArchitectureMetrics, ArchPulseConfig, ParsedFile } from '../types';
...
function calculateMetrics(
  ...
  const averageCoupling = graph.nodes.size > 0 ? totalCoupling / graph.nodes.size : 0;
